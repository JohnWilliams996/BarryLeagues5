...
Partial Class League_Fixtures
    ...
    Sub load_leagues()
        ...
        strSQL = "SELECT league  FROM clubs.vw_leagues ORDER BY league"
    ...
    Sub load_fixtures()
        ...
        strSQL = "SELECT long_name,home_night,phone_number FROM clubs.vw_teams " 'change to vw_teams when LIVE
        ...
        dt.Columns.Add(New DataColumn("Wk41", GetType(System.String)))
        For Team = 1 To TeamCount
            ...
            strSQL = strSQL & " FROM clubs.vw_fixtures a "
            strSQL = strSQL & " LEFT OUTER JOIN clubs.vw_teams b ON a.away_team_name = b.long_name AND b.league = a.league"
            ...
            strSQL = strSQL & " FROM clubs.vw_fixtures a "
            strSQL = strSQL & " INNER JOIN clubs.vw_teams b ON a.home_team_name = b.long_name AND b.league = a.league"
            ...
            While myDataReader.Read()
                ...
                'If Left(myDataReader.Item("Opponents"), 4) <> "OPEN" And myDataReader.Item("Opponents") <> "BYE" Then
    ...
    Private Sub gridLeagues_RowDataBound(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gridLeagues.RowDataBound
        If (e.Row.RowType = DataControlRowType.DataRow) Then
            ...
            hLink.NavigateUrl = "~/Clubs/League Fixtures.aspx?League=" & dt.Rows(gRow)(0).ToString
