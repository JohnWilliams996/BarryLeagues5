...
Public Class MasterPage
    ...
    Sub load_teams()
        ...
        dt.Rows.Add("BILLY CRIBBERS", "BARRIES BOYS", "HARBOUR 'A'", "HARBOUR 'B'")
        dt.Rows.Add("CADOXTON CONS", "BARRY TOWN FC", "MARKET STREET 'C'", "LIBERATORS")
        dt.Rows.Add("LIBERALS", "BREAKAWAYS", "SAVOY 'A'", "SAVOY 'B'")
        dt.Rows.Add("MOORS BOYS", "CAMBRIAN FLYERS", "WEST END 'C'", "SERVICES SOCIAL 'B'")
        dt.Rows.Add("RHOOSE SOCIAL", "J J WINDOWS", "WYNDHAM CONS 'A'", "WANDERERS")
        dt.Rows.Add("WEST END", "RHOOSE SOCIAL 'B'", "WYNDHAM HUSTLERS", "WEST END 'B'")
