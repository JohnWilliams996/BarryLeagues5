<%@ Page Title="" Language="VB" MasterPageFile="~/Clubs/MasterPage.master" AutoEventWireup="false" CodeFile="Club Fixtures.aspx.vb" Inherits="Club_Fixtures" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="gridTeams" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="S2" HeaderText="">
            <HeaderStyle ForeColor="Tan" HorizontalAlign="Center" Wrap="False" Font-Size = "Small" />
            <ItemStyle ForeColor="White" HorizontalAlign="Center" Wrap="False" Font-Size="Small"  />
            </asp:BoundField>

            <asp:BoundField DataField="S3" HeaderText="">
            <HeaderStyle ForeColor="Tan" HorizontalAlign="Center" Wrap="False" Font-Size = "Small" />
            <ItemStyle ForeColor="White" HorizontalAlign="Center" Wrap="False" Font-Size="Small"  />
            </asp:BoundField>

            <asp:BoundField DataField="S4" HeaderText="">
            <HeaderStyle ForeColor="Tan" HorizontalAlign="Center" Wrap="False" Font-Size = "Small" />
            <ItemStyle ForeColor="White" HorizontalAlign="Center" Wrap="False" Font-Size="Small"  />
            </asp:BoundField>

            <asp:BoundField DataField="S5" HeaderText="">
            <HeaderStyle ForeColor="Tan" HorizontalAlign="Center" Wrap="False" Font-Size = "Small" />
            <ItemStyle ForeColor="White" HorizontalAlign="Center" Wrap="False" Font-Size="Small"  />
            </asp:BoundField>
        </Columns>
