<%@ Page Title="" Language="VB" MasterPageFile="~/Clubs/MasterPage.master" AutoEventWireup="false" CodeFile="Stats.aspx.vb" Inherits="Stats" MaintainScrollPositionOnPostback="true"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td valign = "top">
               ...
               <asp:Hyperlink ID="hlTop10" Text = "Show Top 10 Players" Height="27px" 
                 ...
                 <asp:GridView ID="gridCribLeagueStats" runat="server" CssClass="gv"
                   ...
                   <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                    ...
                    <asp:BoundField DataField="Total Won" HeaderText="">
                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                    <ItemStyle BackColor="#1B1B1B" ForeColor="White" HorizontalAlign="Center"  Wrap="False" />
                    </asp:BoundField>

                    <asp:BoundField DataField="Total Won PC" HeaderText="">
                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                    <ItemStyle BackColor="#1B1B1B" ForeColor="White" HorizontalAlign="Right"  Wrap="False" />
                    </asp:BoundField>

                    <asp:BoundField DataField="Points Won" HeaderText="">
                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                    <ItemStyle BackColor="#1B1B1B" ForeColor="White" HorizontalAlign="Right"  Wrap="False" />
                    </asp:BoundField>

                    <asp:BoundField DataField="Points Per Game" HeaderText="" HeaderStyle-Font-Bold="true">
                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
             ...
             <asp:GridView ID="gridSkittlesLeagueStats" runat="server" CssClass="gv"
                    style="margin-top: 0px"  width="200px" 
                AutoGenerateColumns="False" Font-Size="14px"
                Font-Names="Arial" BackColor="#1B1B1B" 
                CellPadding="3" ShowHeader="False" ForeColor="#333333" 
            ...
            <asp:GridView ID="gridSnookerLeagueStats" runat="server" CssClass="gv"
                    style="margin-top: 0px"   width="200px" 
                AutoGenerateColumns="False" Font-Size="14px"
                Font-Names="Arial" BackColor="#1B1B1B" 
                CellPadding="3" ShowHeader="False" ForeColor="#333333" 
                ...
                <Columns>
                    <asp:BoundField  DataField="Last 6"  HeaderText="">
                    <ItemStyle BackColor="#1B1B1B" ForeColor="DarkGray" HorizontalAlign="Right"  Wrap="False" Font-Names="Consolas" Font-Size="Medium"/>
                    </asp:BoundField>
                    ...
                    <ItemStyle BackColor="#1B1B1B" ForeColor="White" HorizontalAlign="Center"  Wrap="False" />
                     ...
                     <asp:BoundField DataField="Total Won PC" HeaderText="" HeaderStyle-Font-Bold="true">
                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                    <ItemStyle BackColor="DarkSlateGray"  ForeColor="White" HorizontalAlign="Right"  Wrap="False" Font-Bold="true"/>
                    </asp:BoundField>
    ...
    <tr >
        <td valign="top">    
                ...
                <asp:GridView ID="gridCribTeamStats" runat="server" CssClass="gv"
                    style="margin-top: 0px"   width="200px" 
                AutoGenerateColumns="False"
                Font-Names="Arial"  BackColor="#1B1B1B" 
                CellPadding="3" ShowHeader="False" ForeColor="#333333" Font-Size="14px"
                GridLines="None">
                <Columns>
                    <asp:BoundField  DataField="Last 6"  HeaderText="">
                        <ItemStyle BackColor="#1B1B1B" ForeColor="DarkGray" HorizontalAlign="Right"  Wrap="False" />
             ...
             <asp:GridView ID="gridSkittlesTeamStats" runat="server" CssClass="gv" style="margin-top: 0px"  width="200px" 
                ...
                <Columns>
                   ...
                   <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                    ...
                    <asp:BoundField DataField="Total HS" HeaderText="" HeaderStyle-Font-Bold="true">
                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                    <ItemStyle BackColor="#1B1B1B" ForeColor="White" HorizontalAlign="Center"  Wrap="False" />
                    </asp:BoundField>
                    ...
                    <asp:BoundField DataField="Home HS" HeaderText="" HeaderStyle-Font-Bold="true">
                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                    <ItemStyle BackColor="#333333" ForeColor="White" HorizontalAlign="Center"  Wrap="False" />
                    </asp:BoundField>
                    ...
                    <asp:BoundField DataField="Away HS" HeaderText="" HeaderStyle-Font-Bold="true">
                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                    <ItemStyle BackColor="#1B1B1B" ForeColor="White" HorizontalAlign="Center"  Wrap="False" />
                    </asp:BoundField>


<%--                    <asp:BoundField DataField="Number Nines" HeaderText="" HeaderStyle-Font-Bold="true">
                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                    <ItemStyle BackColor="#1B1B1B"  ForeColor="LightGreen" HorizontalAlign="Center"  Wrap="False"/>
                    </asp:BoundField>--%>
            ...
            <asp:GridView ID="gridSnookerTeamStats" runat="server" CssClass="gv"
                    style="margin-top: 0px"   width="200px" 
                AutoGenerateColumns="False"
                Font-Names="Arial" BackColor="#1B1B1B" 
                CellPadding="3" ShowHeader="False" ForeColor="#333333" Font-Size="14px"
                ...
                <Columns>
                   ...
                   <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                    ...
                    <asp:BoundField DataField="Home Won" HeaderText="">
                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                    <ItemStyle BackColor="#333333" ForeColor="White" HorizontalAlign="Center"  Wrap="False" />
                    </asp:BoundField>

                     <asp:BoundField DataField="Home Won PC" HeaderText="" HeaderStyle-Font-Bold="true">
                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                    <ItemStyle BackColor="#333333"  ForeColor="White" HorizontalAlign="Right"  Wrap="False" Font-Bold="true"/>
                    </asp:BoundField>
                    ...
                    <asp:BoundField DataField="Away Won" HeaderText="">
                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                    <ItemStyle BackColor="#1B1B1B" ForeColor="White" HorizontalAlign="Center"  Wrap="False" />
                    </asp:BoundField>

                     <asp:BoundField DataField="Away Won PC" HeaderText="" HeaderStyle-Font-Bold="true">
                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                    <ItemStyle BackColor="#1B1B1B"  ForeColor="White" HorizontalAlign="Right"  Wrap="False" Font-Bold="true"/>
                    </asp:BoundField>
        ...
        <td valign="top">
            ...
            <br />
             <asp:GridView ID="gridResults" runat="server" GridLines="None" CssClass="gv" Width="200px" Visible="false"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Home Result"  headerText="Result">
                    <HeaderStyle ForeColor="DarkKhaki" HorizontalAlign="Center" Wrap="False"/>
                    <ItemStyle ForeColor="White" BackColor="DarkGreen" HorizontalAlign="Center" BorderColor="Gray" Wrap="False"/>
                </asp:BoundField>
    ...
    <tr>
        <td valign="top">
           <br />
                ...
                <asp:GridView ID="gridCribPlayerStats" runat="server" CssClass="gv"
                    style="margin-top: 0px"  width="200px" 
                ...
                <Columns>
                   ...
                   <asp:BoundField DataField="Partner" HeaderText="">
                    <ItemStyle BackColor="#1B1B1B" ForeColor="White" HorizontalAlign="Left"  Wrap="False" />
                    </asp:BoundField>

                     <asp:BoundField DataField="Opponent Team" HeaderText="">
                    <ItemStyle BackColor="#1B1B1B" ForeColor="Cyan" HorizontalAlign="Left"  Wrap="False" />
                    </asp:BoundField>

                    <asp:BoundField DataField="Opponent Player" HeaderText="">
                    <ItemStyle BackColor="#1B1B1B" ForeColor="White" HorizontalAlign="Left"  Wrap="False" />
                    </asp:BoundField>

                   <asp:BoundField DataField="Opponent Partner" HeaderText="">
                    <ItemStyle BackColor="#1B1B1B" ForeColor="White" HorizontalAlign="Left"  Wrap="False" />
                    </asp:BoundField>
                    ...
                    <ItemStyle BackColor="DarkSlateGray"  ForeColor="White" HorizontalAlign="Center"  Wrap="False"/>
                    </asp:BoundField>

                    <asp:BoundField DataField="Match" HeaderText="" HeaderStyle-Font-Bold="true">
                ...
                <asp:GridView ID="gridSkittlesPlayerStats" runat="server" CssClass="gv"
                    style="margin-top: 0px"   width="200px" 
                    AutoGenerateColumns="False"
...
<%--                    <asp:BoundField DataField="Number Nines" HeaderText="" HeaderStyle-Font-Bold="true" Visible = "true">
                    <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                ...
                <asp:GridView ID="gridSnookerPlayerStats" runat="server" CssClass="gv"
                    style="margin-top: 0px"  width="200px" 
                    AutoGenerateColumns="False"
                    Font-Names="Arial"  BackColor="#1B1B1B" 
                    CellPadding="2" CellSpacing="2" ShowHeader="False" ForeColor="#333333" Font-Size="12px"
                    GridLines="None">
                <Columns>
            ...
            <br />        
                ...
                <asp:Label ID="lblPartnerStats" Text="PARTNER STATS ()" Height="33px"  
                    runat="server" ForeColor="#E4BB18" BorderWidth="0px" 
                Font-Names="Arial" BackColor="#1B1B1B" Font-Size="16px"
                Visible="False" ></asp:Label>
            ...
            <br />        
                ...
                <asp:GridView ID="gridCribPartnerStats" runat="server" CssClass="gv"
                    style="margin-top: 0px"   width="200px" 
                AutoGenerateColumns="False"
                Font-Names="Arial"  BackColor="#1B1B1B" 
                CellPadding="2" ShowHeader="False" ForeColor="#333333" Font-Size="12px"
