...
Public Class MasterPage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            End If
            HomeHL.NavigateUrl = "~/Ladies_Skit/Default.aspx?Week=" & objGlobals.GetCurrentWeek
    ...
    Sub load_last_updated()
        ...
        strSQL = "SELECT date_time_changed FROM ladies_skit.last_changed"
    ...
    Protected Sub btnGo_Click(sender As Object, e As System.EventArgs) Handles btnGo.Click
        ...
        Else
            ...
            Response.Redirect("~/Ladies_Skit/Default.aspx?Week=" & objGlobals.GetCurrentWeek)
        End If
    ...
    Sub load_teams()
        ...
        dt.Rows.Add("BARRY STARS", "BREAKAWAYS", "ALL ABOUT US")
        dt.Rows.Add("BOBBYS GIRLS", "CLICKIES", "BALL BUSTERS")
        dt.Rows.Add("BOOZY BIRDS", "COLCOT LADIES", "BANDITS")
        dt.Rows.Add("CAD CONS FILLIES", "ETCETERA", "DIVAS")
        dt.Rows.Add("CHALLENGERS", "FALLEN ANGELS", "DOLLY MIXTURES")
        dt.Rows.Add("CIGAR LADIES", "HILLBILLIES", "DOWN TOWN GALS")
        dt.Rows.Add("COPPERS", "OPTIMISTS", "ISLAND FRAGGLES")
        dt.Rows.Add("DRIFTERS", "PERSUADERS", "LIVIN ON A SPARE")
        dt.Rows.Add("FAMILY AFFAIR", "RHOOSE STARLIGHTS", "MARRINETTES")
        dt.Rows.Add("PILA PALA", "RUGBY TRIERS", "MERRY DEVILS")
        dt.Rows.Add("RED ADMIRAL", "SPECIAL ANGELS", "NITE OUTERS")
        dt.Rows.Add("SEA VIEW GALS", "WESTENDERS", "ROLLING ON THE RAILWAY")
        dt.Rows.Add("SPACE FINDERS", "WITCHILL WEEBIES", "WITCHES")
        dt.Rows.Add("VIXENS", "", "WITCHILL WANDERERS")
    ...
    Protected Sub gridTeams_RowDataBound(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gridTeams.RowDataBound
        If (e.Row.RowType = DataControlRowType.DataRow) Then
            ...
            hLink1.NavigateUrl = "~/Ladies_Skit/Team Fixtures.aspx?League=DIVISION 1&Team=" & Replace(e.Row.Cells(0).Text, "&#39;", Chr(34))
            hLink1.ForeColor = Cyan
            hLink1.Text = e.Row.Cells(0).Text
            e.Row.Cells(0).Controls.Add(hLink1)

            Dim hLink2 As New HyperLink
            hLink2.NavigateUrl = "~/Ladies_Skit/Team Fixtures.aspx?League=DIVISION 2&Team=" & Replace(e.Row.Cells(1).Text, "&#39;", Chr(34))
            hLink2.ForeColor = Cyan
            hLink2.Text = e.Row.Cells(1).Text
            e.Row.Cells(1).Controls.Add(hLink2)

            Dim hLinK3 As New HyperLink
            hLinK3.NavigateUrl = "~/Ladies_Skit/Team Fixtures.aspx?League=DIVISION 3&Team=" & Replace(e.Row.Cells(2).Text, "&#39;", Chr(34))
