...
Partial Class Admin_Fixture_Result
    ...
    Protected Sub update_result(ByVal inResult As String)
        ...
        If Val(HomeScore) + Val(AwayScore) = 0 Then
            strSQL = "UPDATE ladies_skit.vw_fixtures_AR SET"
        ...
        strSQL = strSQL & " FROM ladies_skit.vw_teams_AR t"
        strSQL = strSQL & " JOIN ladies_skit.vw_home_tables_AR h ON (h.League = t.League AND h.Team = t.long_name)"
        strSQL = strSQL & " JOIN ladies_skit.vw_away_tables_AR a ON (a.League = t.League AND a.Team = t.long_name)"
        ...
        If InStr(inResult, "0-0") > 0 Or inResult = "Postponed" Then
            ...
            strSQL = "UPDATE ladies_skit.vw_fixtures_AR SET Status = " & NewStatus & " WHERE fixture_id = " & CompID
            myDataReader = objGlobals.SQLSelect(strSQL)
            ...
            'myDataReader = objGlobals.SQLSelect(strSQL)
        Else
            strSQL = "UPDATE ladies_skit.vw_fixtures_AR SET Status = 1 WHERE fixture_id = " & CompID
            myDataReader = objGlobals.SQLSelect(strSQL)
        End If
        '28.7.14 - end
    ...
    Protected Sub btnCancel_Click(sender As Object, e As System.EventArgs) Handles btnCancel.Click
        Response.Redirect("~/Ladies_Skit/Alan Rosser Cup.aspx?Group=" & GroupName)
    End Sub
