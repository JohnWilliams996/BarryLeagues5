...
Partial Class Admin_Cup_Results
    ...
    Sub load_comps()
        ...
        strSQL = "SELECT Competition FROM ladies_skit.vw_Comps ORDER BY Competition"
    ...
    Protected Sub gridResults_RowCommand(sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gridResults.RowCommand
        ...
        Select Case e.CommandName
            Case "HomeWin"
                strSQL = "EXEC ladies_skit.sp_update_comp_result '" & objGlobals.current_season & "','" & CompName & "','" & MatchNo & "','H'"
            Case "AwayWin"
                strSQL = "EXEC ladies_skit.sp_update_comp_result '" & objGlobals.current_season & "','" & CompName & "','" & MatchNo & "','A'"
            Case "NotPlayed"
                strSQL = "EXEC ladies_skit.sp_update_comp_result '" & objGlobals.current_season & "','" & CompName & "','" & MatchNo & "','N'"
            Case "Reset"
                strSQL = "EXEC ladies_skit.sp_update_comp_result '" & objGlobals.current_season & "','" & CompName & "','" & MatchNo & "','X'"
        End Select
        myDataReader = objGlobals.SQLSelect(strSQL)
    ...
    Sub write_cup_draws_FTP()
        ...
        strSQL = "EXEC [ladies_skit].[sp_write_cup_draws_FTP] '" & l_param_in_values(0) & "'"
        myDataReader = objGlobals.SQLSelect(strSQL)
