<%@ Page Title="" Language="VB" MasterPageFile="~/Ladies_Skit/MasterPage.master" AutoEventWireup="false" CodeFile="Fixture Result.aspx.vb" Inherits="Admin_Fixture_Result" %>
...
<div id = "Admin">
 <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
    ...
    <table >
        <tr>
            <td align="left">
                <asp:Label ID="lblResult" runat="server" ForeColor="#E4BB18" Text="Result" BorderWidth="0px" Font-Names="Arial"></asp:Label>
            ...
            <td valign="bottom">
                ...
                <asp:Label ID="lblRolls" runat="server" ForeColor="#E4BB18" Text="Rolls" BorderWidth="0px" Font-Names="Arial"></asp:Label>
                <br />
           ...
           <td align="right"valign="bottom">
                 <asp:Label ID="lblHome" runat="server" ForeColor="#E4BB18" Text="Home" Font-Names="Arial" Font-Size="12px" ></asp:Label><br />
           ...
           <td align="center"valign="bottom">
                 <asp:Label ID="lblRollNo" runat="server" ForeColor="#E4BB18" Text="Roll" Font-Names="Arial" Font-Size="12px" Height="22px"></asp:Label><br />
                 <asp:Label ID="lblRoll1" runat="server" ForeColor="#E4BB18" Text="1" Font-Names="Arial" Font-Size="12px" Height="22px"></asp:Label><br />
                 <asp:Label ID="lblRoll2"  runat="server" ForeColor="#E4BB18" Text="2" Font-Names="Arial" Font-Size="12px" Height="22px"></asp:Label><br />
                 <asp:Label ID="lblRoll3"  runat="server" ForeColor="#E4BB18" Text="3" Font-Names="Arial" Font-Size="12px" Height="22px"></asp:Label><br />
                 <asp:Label ID="lblRoll4"  runat="server" ForeColor="#E4BB18" Text="4" Font-Names="Arial" Font-Size="12px" Height="22px"></asp:Label><br />
                 <asp:Label ID="lblRoll5"  runat="server" ForeColor="#E4BB18" Text="5" Font-Names="Arial" Font-Size="12px" Height="22px"></asp:Label><br />
                 <asp:Label ID="lblPoints"  runat="server" ForeColor="#E4BB18" Text="Points" Font-Names="Arial" Font-Size="12px" Height="22px"></asp:Label>
                 <br />
                 <asp:Label ID="lblTotal"  runat="server" ForeColor="#E4BB18" Text="Total" Font-Names="Arial" Font-Size="12px" Height="22px"></asp:Label><br />
            </td>
            <td align="left"valign="bottom">
                 <asp:Label ID="lblAway" runat="server" ForeColor="#E4BB18" Text="Away" Font-Names="Arial" Font-Size="12px" ></asp:Label><br />
            ...
            <td align="left"valign="bottom">
                ...
                <asp:Button ID="btnCancel" runat="server" Text="Cancel" Height="38px" 
                Width="113px" Font-Names="Arial" BackColor="Black" 
                ForeColor="White"/>
                <br />
                <br />

                <asp:Button ID="btnAddEditResult" runat="server" Text="Add/Edit Players" Height="63px" 
                    Width="112px" Font-Names="Arial" BackColor="Red" 
                    ForeColor="White"/>
            </td>
        </tr>
        <tr>
           ...
           <td align="left"valign="bottom">
            ...
            <td align="left"valign="top">
                ...
                visible="true" ForeColor="White" Width="134px" />
