...
Partial Class Admin_Fixture_Result
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not Request.Cookies("lastVisit") Is Nothing Then
            ...
            If objGlobals.TeamSelected Is Nothing Then
                btnAddEditResult.PostBackUrl = "~/Ladies_Skit/Admin/Add Edit Result 2.aspx?ID=" & CompID & "&Week=" & FixtureWeek
            Else
                btnAddEditResult.PostBackUrl = "~/Ladies_Skit/Admin/Add Edit Result 2.aspx?ID=" & CompID & "&Week=" & FixtureWeek & "&Team=" & objGlobals.TeamSelected
            End If
        Else
    ...
    Protected Sub create_tables_before()
        ...
        strSQL = "TRUNCATE TABLE ladies_skit.before_tables"
        myDataReader = objGlobals.SQLSelect(strSQL)

        strSQL = "SELECT DISTINCT(team) FROM ladies_skit.vw_tables WHERE league = '" & FixtureLeague & "'"
        myDataReader = objGlobals.SQLSelect(strSQL)
        While myDataReader.Read
            ThisTeam = myDataReader.Item(0)
            strSQL = "INSERT INTO ladies_skit.before_tables VALUES ('" & tempSeason & "','" & FixtureLeague & "',1,'" & ThisTeam & "',0,0,0,0,0,0)"
        ...
        strSQL = strSQL + " FROM ladies_skit.vw_teams t"
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures AS a ON a.League = t.League AND a.home_team_name = t.long_name AND a.home_result <> '0 - 0'"
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures b ON b.fixture_id = a.fixture_id AND b.home_points > b.away_points"
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures c ON c.fixture_id = a.fixture_id AND c.home_points = c.away_points AND c.home_result <> '0 - 0'"
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures d ON d.fixture_id = a.fixture_id AND d.home_points < d.away_points"
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures e ON e.fixture_id = a.fixture_id"
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures f ON f.fixture_id = a.fixture_id "
        ...
        While myDataReader.Read()
            ...
            strSQL = "UPDATE ladies_skit.before_tables SET Pld=" & BeforePlayed & ",W=" & BeforeWon & ",D=" & BeforeDrawn & ",L=" & BeforeLost & ",pts=" & BeforePoints & ",rolls=" & BeforeRolls & ",pins=" & BeforePins & ",Pts_Rolls_Pins = " & BeforePoints_Rolls_Pins
        ...
        strSQL = strSQL + " FROM ladies_skit.vw_teams t"
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures AS a ON a.League = t.League AND a.away_team_name = t.long_name AND a.away_result <> '0 - 0'"
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures b ON b.fixture_id = a.fixture_id AND b.away_points > b.home_points"
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures c ON c.fixture_id = a.fixture_id AND c.away_points = c.home_points AND c.away_result <> '0 - 0'"
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures d ON d.fixture_id = a.fixture_id AND d.away_points < d.home_points"
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures e ON e.fixture_id = a.fixture_id"
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures f ON f.fixture_id = a.fixture_id "
        ...
        While myDataReader.Read()
            ...
            BeforePins = myDataReader.Item("pins")
            BeforePoints_Rolls_Pins = (BeforePoints * 1000000) + (BeforeRolls * 100000) + BeforePins
            strSQL = "UPDATE ladies_skit.before_tables SET Pld=Pld+" & BeforePlayed & ",W=W+" & BeforeWon & ",D=D+" & BeforeDrawn & ",L=L+" & BeforeLost & ",pts=pts+" & BeforePoints & ",rolls=rolls+" & BeforeRolls & ",pins=pins+" & BeforePins & ",Pts_Rolls_Pins=Pts_Rolls_Pins+" & BeforePoints_Rolls_Pins
            strSQL = strSQL & " WHERE team = '" & ThisTeam & "'"
            myDataReader2 = objGlobals.SQLSelect(strSQL)
        End While
        strSQL = "SELECT * FROM ladies_skit.before_tables ORDER BY Pts_Rolls_Pins DESC,pld,W"
        myDataReader = objGlobals.SQLSelect(strSQL)
        ...
        While myDataReader.Read()
            ...
            If LastPoints <> myDataReader.Item("Pts_Rolls_Pins") Then
                ...
                LastPoints = myDataReader.Item("Pts_Rolls_Pins")
            End If
            strSQL = "UPDATE ladies_skit.before_tables SET Pos = " + CStr(Pos1)
    ...
    Protected Sub create_tables_after(ByVal inDate As String)
        ...
        strSQL = "TRUNCATE TABLE ladies_skit.after_tables"
        myDataReader = objGlobals.SQLSelect(strSQL)
        ...
        While myDataReader.Read
            ThisTeam = myDataReader.Item(0)
            strSQL = "INSERT INTO ladies_skit.after_tables VALUES ('" & tempSeason & "','" & FixtureLeague & "',1,'" & ThisTeam & "',0,0,0,0,0,0,0,0)"
            myDataReader2 = objGlobals.SQLSelect(strSQL)
        End While
        ...
        strSQL = strSQL + " FROM ladies_skit.vw_teams t"
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures a ON a.League = t.League AND a.home_team_name = t.long_name AND a.home_result <> '0 - 0'"
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures a1 ON a1.fixture_id = a.fixture_id AND a1.home_result = '0 - 0' "
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures b ON b.fixture_id = a.fixture_id AND b.home_points > b.away_points"
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures c ON c.fixture_id = a.fixture_id AND c.home_points = c.away_points AND c.home_result <> '0 - 0'"
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures d ON d.fixture_id = a.fixture_id AND d.home_points < d.away_points"
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures e ON e.fixture_id = a.fixture_id"
        ...
        While myDataReader.Read()
            ...
            strSQL = "UPDATE ladies_skit.after_tables SET Pld=" & AfterPlayed & ",W=" & AfterWon & ",D=" & AfterDrawn & ",L=" & AfterLost & ",pts=" & AfterPoints & ",rolls=" & AfterRolls & ",pins=" & AfterPins & ",Pts_Rolls_Pins=" & AfterPoints_Rolls_Pins
            strSQL = strSQL & " WHERE team = '" & ThisTeam & "'"
            myDataReader2 = objGlobals.SQLSelect(strSQL)
        End While
        ...
        strSQL = strSQL + " FROM ladies_skit.vw_teams t"
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures a ON a.League = t.League AND a.away_team_name = t.long_name AND a.away_result <> '0 - 0'"
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures a1 ON a1.fixture_id = a.fixture_id AND a1.away_result = '0 - 0' "
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures b ON b.fixture_id = a.fixture_id AND b.away_points > b.home_points"
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures c ON c.fixture_id = a.fixture_id AND c.away_points = c.home_points AND c.away_result <> '0 - 0'"
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures d ON d.fixture_id = a.fixture_id AND d.away_points < d.home_points"
        strSQL = strSQL + " LEFT OUTER JOIN ladies_skit.vw_fixtures e ON e.fixture_id = a.fixture_id"
        ...
        While myDataReader.Read()
            ...
            AfterPins = myDataReader.Item("pins")
            AfterPoints_Rolls_Pins = (AfterPoints * 1000000) + (AfterRolls * 100000) + AfterPins
            strSQL = "UPDATE ladies_skit.after_tables SET Pld=Pld+" & AfterPlayed & ",W=W+" & AfterWon & ",D=D+" & AfterDrawn & ",L=L+" & AfterLost & ",pts=pts+" & AfterPoints & ",Rolls=Rolls+" & AfterRolls & ",Pins=Pins+" & AfterPins & ",Pts_Rolls_Pins=Pts_Rolls_Pins+" & AfterPoints_Rolls_Pins
            strSQL = strSQL & " WHERE team = '" & ThisTeam & "'"
            myDataReader2 = objGlobals.SQLSelect(strSQL)
        End While
        strSQL = "SELECT * FROM ladies_skit.after_tables ORDER BY Pts_Rolls_Pins DESC,pld,W"
        myDataReader = objGlobals.SQLSelect(strSQL)
        ...
        While myDataReader.Read()
            ...
            If LastPoints <> myDataReader.Item("Pts_Rolls_Pins") Then
                ...
                LastPoints = myDataReader.Item("Pts_Rolls_Pins")
            End If
            strSQL = "UPDATE ladies_skit.after_tables SET Pos = " + CStr(Pos1)
            strSQL = strSQL + " WHERE team = '" + myDataReader.Item("team") + "'"
            myDataReader2 = objGlobals.SQLSelect(strSQL)
        End While
    End Sub
    ...
    Protected Sub update_result(ByVal inResult As String)
        ...
        If Val(HomeScore) + Val(AwayScore) = 0 Then
            strSQL = "UPDATE ladies_skit.vw_fixtures SET"
        ...
        strSQL = strSQL & " FROM ladies_skit.vw_teams t"
        strSQL = strSQL & " JOIN ladies_skit.vw_home_tables h ON (h.League = t.League AND h.Team = t.long_name)"
        strSQL = strSQL & " JOIN ladies_skit.vw_away_tables a ON (a.League = t.League AND a.Team = t.long_name)"
        strSQL = strSQL & " WHERE t.League = '" & FixtureLeague & "'"
        strSQL = strSQL & " AND t.long_name <> 'BYE'"
        strSQL = strSQL & " GROUP BY t.long_name"
        ...
        If InStr(inResult, "0-0") > 0 Or inResult = "Postponed" Then
            ...
            strSQL = "UPDATE ladies_skit.vw_fixtures SET Status = " & NewStatus & " WHERE fixture_id = " & CompID
            myDataReader = objGlobals.SQLSelect(strSQL)
            strSQL = "DELETE FROM ladies_skit.vw_fixtures_detail WHERE fixture_id = " & CompID
            myDataReader = objGlobals.SQLSelect(strSQL)
            Call update_player_stats("sp_update_player_stats")

            're-update league AND team positions
            strSQL = "EXEC ladies_skit.sp_update_league_position '" & FixtureLeague & "'"
            myDataReader = objGlobals.SQLSelect(strSQL)

            strSQL = "EXEC ladies_skit.sp_update_team_position '" & FixtureLeague & "','" & FixtureHomeTeam & "'"
            myDataReader = objGlobals.SQLSelect(strSQL)

            strSQL = "EXEC ladies_skit.sp_update_team_position '" & FixtureLeague & "','" & FixtureAwayTeam & "'"
            myDataReader = objGlobals.SQLSelect(strSQL)
        Else
            fixture_status = FixtureStatus()
            If fixture_status = 0 Then fixture_status = 1
            strSQL = "UPDATE ladies_skit.vw_fixtures SET Status = " & fixture_status & " WHERE fixture_id = " & CompID
            myDataReader = objGlobals.SQLSelect(strSQL)
        End If
        '28.7.14 - end

        '19.11.18 - update fixture_combined table
        Call objGlobals.update_fixtures_combined("ladies_skit")

        strSQL = "UPDATE ladies_skit.last_changed SET date_time_changed = '" & UKDate & UKTime & "'"
    ...
    Sub update_player_stats(inStoredProcedure As String)
        ...
        strSQL = "SELECT player FROM ladies_skit.vw_players WHERE league = '" & FixtureLeague & "' AND team = '" & FixtureHomeTeam & "' AND player NOT LIKE 'A N OTHER%' "
        myDataReader = objGlobals.SQLSelect(strSQL)
        While myDataReader.Read()
        ...
        strSQL = "SELECT player FROM ladies_skit.vw_players WHERE league = '" & FixtureLeague & "' AND team = '" & FixtureAwayTeam & "' AND player NOT LIKE 'A N OTHER%' "
        myDataReader = objGlobals.SQLSelect(strSQL)
        While myDataReader.Read()
    ...
    Protected Function FixtureStatus() As Integer
        FixtureStatus = 1
        strSQL = "SELECT COUNT(*) FROM ladies_skit.vw_fixtures_detail WHERE fixture_id = " & CompID
        myDataReader = objGlobals.SQLSelect(strSQL)
        While myDataReader.Read()
    ...
    Protected Function get_end_week_date(ByVal inWeek As Integer) As String
        get_end_week_date = ""
        strSQL = "SELECT week_commences FROM ladies_skit.vw_weeks WHERE week_number = " & inWeek
        myDataReader = objGlobals.SQLSelect(strSQL)
        While myDataReader.Read()
    ...
    Protected Sub update_weekly_tables(ByVal inTable As String, ByVal inWeek As Integer)
        strSQL = "DELETE FROM ladies_skit.vw_tables_week WHERE league = '" & FixtureLeague & "' AND week = " & inWeek
        myDataReader = objGlobals.SQLSelect(strSQL)
        strSQL = "INSERT INTO ladies_skit.tables_week SELECT season,league," & inWeek & ",pos,team,pts,rolls,pins,Pts_Rolls_Pins FROM ladies_skit." & inTable & " WHERE league = '" & FixtureLeague & "' AND season = '" & objGlobals.get_current_season & "'"
        myDataReader = objGlobals.SQLSelect(strSQL)
    End Sub
    ...
    Protected Sub re_update_table(inTable As String)
        ...
        strSQL = "DELETE FROM ladies_skit.vw_" & inTable & " WHERE league ='" & FixtureLeague & "'"

        myDataReader = objGlobals.SQLSelect(strSQL)

        For i = 0 To gridTable.Rows.Count - 1
            strSQL = "INSERT INTO ladies_skit." & inTable & " VALUES ('"
    ...
    Sub update_log(inSQL As String)
        ...
        logSQL = "INSERT INTO ladies_skit.update_log VALUES ('" & strNow & "','" & inSQL & "')"
    ...
    Sub load_table(inGrid As GridView, inTable As String)
        ...
        strSQL = "SELECT * FROM ladies_skit." & inTable & " WHERE season = '" & objGlobals.current_season & "' AND league = '" & FixtureLeague & "' ORDER BY pos"
        myDataReader = objGlobals.SQLSelect(strSQL)
    ...
    Protected Sub btnCancel_Click(sender As Object, e As System.EventArgs) Handles btnCancel.Click
        ...
        Else
            Response.Redirect("~/Ladies_Skit/Team Fixtures.aspx?League=" & objGlobals.LeagueSelected & "&Team=" & objGlobals.TeamSelected)
        End If
    End Sub
    ...
    Sub write_fixtures_FTP()
        ...
        strSQL = "EXEC [ladies_skit].[sp_write_fixtures_FTP] '" & objGlobals.current_season & "'," & l_param_in_values(0)
        myDataReader = objGlobals.SQLSelect(strSQL)
    ...
    Protected Sub Calendar1_SelectionChanged(sender As Object, e As System.EventArgs) Handles Calendar1.SelectionChanged
        ...
        strSQL = "EXEC [ladies_skit.tools_16].[sp_check_fixture_exists] '" & l_param_in_values(0) & "'," & l_param_in_values(1) & ",'" & l_param_in_values(2) & "','" & l_param_in_values(3) & "','" & l_param_in_values(4) & "','" & l_param_in_values(5) & "'"
        myDataReader = objGlobals.SQLSelect(strSQL)
        While myDataReader.Read
    ...
    Protected Sub btnUpdateDateStatus_Click(sender As Object, e As System.EventArgs) Handles btnUpdateDateStatus.Click
        ...
        strSQL = "EXEC [ladies_skit.tools_16].[sp_update_fixture_date_status] '" & l_param_in_values(0) & "'," & l_param_in_values(1) & ",'" & l_param_in_values(2) & "','" & l_param_in_values(3) & "','" & l_param_in_values(4) & "','" & l_param_in_values(5) & "'"
        myDataReader = objGlobals.SQLSelect(strSQL)
