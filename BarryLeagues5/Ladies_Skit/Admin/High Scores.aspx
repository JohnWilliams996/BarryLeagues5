<%@ Page Title="" Language="VB" MasterPageFile="~/Ladies_Skit/MasterPage.master" AutoEventWireup="false" CodeFile="High Scores.aspx.vb" Inherits="Admin_High_Scores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM ladies_skit.vw_high_scores  ORDER BY league, home_away DESC" 
        DeleteCommand="DELETE FROM ladies_skit.vw_high_scores WHERE ID = @ID" 
        InsertCommand="INSERT INTO ladies_skit.vw_high_scores VALUES (@League,@HomeAway,@Player,@Team,@Score,@Print)" 
        UpdateCommand="UPDATE ladies_skit.vw_high_scores SET League = @League, HomeAway = @HomeAway, Player = @Player, Team = @Team, Score = @Score, _Print = @Print WHERE ID = @ID">
        <DeleteParameters>
