...
Partial Class Admin_Add_Edit_Result_2
    ...
    Protected Sub load_result()
        ...
        strSQL = "SELECT * FROM ladies_skit.vw_fixtures WHERE fixture_id = " & fixture_id
    ...
    Sub load_details()
        ...
        If Not IsPostBack Then
            strSQL = "EXEC ladies_skit.sp_get_result " + fixture_id.ToString + "," + FixtureStatus.ToString
            myDataReader = objGlobals.SQLSelect(strSQL)
        End If
        strSQL = "SELECT * FROM ladies_skit.fixtures_detail_temp WHERE fixture_id = " & fixture_id & " ORDER BY 1"
        myDataReader = objGlobals.SQLSelect(strSQL)
        While myDataReader.Read()
            With gridResult
                dr = dt.NewRow
    ...
    Protected Sub btnRandom_Click(sender As Object, e As System.EventArgs) Handles btnRandom.Click
        ...
        strSQL = "DELETE FROM ladies_skit.vw_fixtures_detail WHERE fixture_id = " + fixture_id.ToString
        myDataReader = objGlobals.SQLSelect(strSQL)
        strSQL = "EXEC ladies_skit.sp_get_result " + fixture_id.ToString + "," + FixtureStatus.ToString
        myDataReader = objGlobals.SQLSelect(strSQL)
        load_result()
            ...
            Case "HomePlayerAvailable"      'player is available - find slot to be selected
                ...
                For iRow As Integer = 1 To 12
                    ...
                    If Button2.Text = "" Then
                        Button2.Text = Button1.Text
                        Button1.Text = ""
                        strSQL = "UPDATE ladies_skit.fixtures_detail_temp SET home_player_available = '' WHERE fixture_id = " & fixture_id & " AND home_player_available =  '" + Button2.Text + "'"
                        myDataReader = objGlobals.SQLSelect(strSQL)
                        strSQL = "UPDATE ladies_skit.fixtures_detail_temp SET home_player_selected = '" + Button2.Text + "' WHERE fixture_id = " & fixture_id & " AND match =  " + iRow.ToString
                        myDataReader = objGlobals.SQLSelect(strSQL)
                        Exit For
                    End If
                Next
            Case "HomePlayerSelected"      'player is selected - find slot to be available
                ...
                For iRow As Integer = 1 To gridResult.Rows.Count - 1
                    ...
                    If Button1.Text = "" Then
                        ...
                        Button2.Text = ""
                        strSQL = "UPDATE ladies_skit.fixtures_detail_temp SET home_player_available = '" + Button1.Text + "' WHERE fixture_id = " & fixture_id & " AND match =  " + iRow.ToString
                        myDataReader = objGlobals.SQLSelect(strSQL)
                        strSQL = "UPDATE ladies_skit.fixtures_detail_temp SET home_player_selected = '' WHERE fixture_id = " & fixture_id & " AND match =  " + index.ToString
                        myDataReader = objGlobals.SQLSelect(strSQL)
                        Exit For
                    End If
                Next
            Case "AwayPlayerAvailable"      'player is available - find slot to be selected
                ...
                For iRow As Integer = 1 To 12
                    ...
                    If Button4.Text = "" Then
                        ...
                        Button3.Text = ""
                        strSQL = "UPDATE ladies_skit.fixtures_detail_temp SET away_player_available = '' WHERE fixture_id = " & fixture_id & " AND away_player_available =  '" + Button4.Text + "'"
                        myDataReader = objGlobals.SQLSelect(strSQL)
                        strSQL = "UPDATE ladies_skit.fixtures_detail_temp SET away_player_selected = '" + Button4.Text + "' WHERE fixture_id = " & fixture_id & " AND match =  " + iRow.ToString
                        myDataReader = objGlobals.SQLSelect(strSQL)
                        Exit For
                    End If
                Next
            Case "AwayPlayerSelected"      'player is selected - find slot to be available
                ...
                For iRow As Integer = 1 To gridResult.Rows.Count - 1
                    ...
                    If Button3.Text = "" Then
                        ...
                        Button4.Text = ""
                        strSQL = "UPDATE ladies_skit.fixtures_detail_temp SET away_player_available = '" + Button3.Text + "' WHERE fixture_id = " & fixture_id & " AND match =  " + iRow.ToString
                        myDataReader = objGlobals.SQLSelect(strSQL)
                        strSQL = "UPDATE ladies_skit.fixtures_detail_temp SET away_player_selected = '' WHERE fixture_id = " & fixture_id & " AND match =  " + index.ToString
                        myDataReader = objGlobals.SQLSelect(strSQL)
                        Exit For
                    End If
                Next
    ...
    Protected Sub update_grid_home(inMatch As Integer, inHomeScore As Double)
        ...
        strSQL = "UPDATE ladies_skit.fixtures_detail_temp SET "
    ...
    Protected Sub btnAdd1_Click(sender As Object, e As System.EventArgs) Handles btnAdd1.Click
        ...
        For iRow As Integer = 1 To gridResult.Rows.Count - 1
            ...
            If Button1.Text = "" Then
                ...
                Added = True
                strSQL = "UPDATE ladies_skit.fixtures_detail_temp SET home_player_available = '" + txtAddHomePlayer.Text + "' WHERE fixture_id = " & fixture_id & " AND ID =  " + iRow.ToString
                myDataReader = objGlobals.SQLSelect(strSQL)
                Exit For
            Else
                NewRow = NewRow + 1
        ...
        If Not Added Then
            NewRow = NewRow + 1
            If NewRow <= 12 Then
                strSQL = "INSERT INTO ladies_skit.fixtures_detail_temp VALUES (" & fixture_id & ",'" & txtAddHomePlayer.Text & "','',null," & NewRow & ",null,'','')"
            Else
                strSQL = "INSERT INTO ladies_skit.fixtures_detail_temp VALUES (" & fixture_id & ",'" & txtAddHomePlayer.Text & "','',null,null,null,'','')"
            End If
            myDataReader = objGlobals.SQLSelect(strSQL)
        End If
        'add to players table
        strSQL = "INSERT INTO ladies_skit.players VALUES ('" & objGlobals.current_season & "',"
    ...
    Protected Sub btnAdd2_Click(sender As Object, e As System.EventArgs) Handles btnAdd2.Click
        ...
        For iRow As Integer = 1 To gridResult.Rows.Count - 1
            ...
            If Button4.Text = "" Then
                ...
                Added = True
                strSQL = "UPDATE ladies_skit.fixtures_detail_temp SET away_player_available = '" + txtAddAwayPlayer.Text + "' WHERE fixture_id = " & fixture_id & " AND ID =  " + iRow.ToString
                myDataReader = objGlobals.SQLSelect(strSQL)
                Exit For
            Else
                NewRow = NewRow + 1
        ...
        If Not Added Then
            NewRow = NewRow + 1
            strSQL = "INSERT INTO ladies_skit.fixtures_detail_temp VALUES (" & fixture_id & ",'','',null,null,null,'','" & txtAddAwayPlayer.Text & "')"
            myDataReader = objGlobals.SQLSelect(strSQL)
        End If
        'add to players table
        strSQL = "INSERT INTO ladies_skit.players VALUES ('" & objGlobals.current_season & "',"
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As System.EventArgs) Handles btnUpdate.Click
        ...
        strSQL = "EXEC ladies_skit.sp_update_league_position '" & lblLeague.Text & "'"
        myDataReader = objGlobals.SQLSelect(strSQL)

        strSQL = "EXEC ladies_skit.sp_update_team_position '" & lblLeague.Text & " ','" & lblHomeTeam.Text & "'"
        myDataReader = objGlobals.SQLSelect(strSQL)

        strSQL = "EXEC ladies_skit.sp_update_team_position '" & lblLeague.Text & "','" & lblAwayTeam.Text & "'"
        myDataReader = objGlobals.SQLSelect(strSQL)
    ...
    Sub update_player_stats(inStoredProcedure As String)
        ...
        strSQL = "SELECT player FROM ladies_skit.vw_players WHERE league = '" & lblLeague.Text & "' AND team = '" & lblHomeTeam.Text & "' AND player NOT LIKE 'A N OTHER%' "
        myDataReader = objGlobals.SQLSelect(strSQL)
        While myDataReader.Read()
            strSQL = "EXEC " & inStoredProcedure & " '" & tempSeason & "','" & lblLeague.Text & "','" & lblHomeTeam.Text & "','" & myDataReader.Item("player") & "'"
            myDataReader2 = objGlobals.SQLSelect(strSQL)
        End While

        'update the away team players
        strSQL = "SELECT player FROM ladies_skit.vw_players WHERE league = '" & lblLeague.Text & "' AND team = '" & lblAwayTeam.Text & "' AND player NOT LIKE 'A N OTHER%' "
        myDataReader = objGlobals.SQLSelect(strSQL)
        While myDataReader.Read()
            strSQL = "EXEC " & inStoredProcedure & " '" & tempSeason & "','" & lblLeague.Text & "','" & lblAwayTeam.Text & "','" & myDataReader.Item("player") & "'"
            myDataReader2 = objGlobals.SQLSelect(strSQL)
        End While
    End Sub
    ...
    Sub update_header()
        ...
        strSQL = "UPDATE ladies_skit.vw_fixtures SET home_rolls_won = " & HomeRollsWon & ",away_rolls_won = " & AwayRollsWon
    ...
    Sub update_fixture_details()
        Dim strSQL As String
        Dim myDataReader As OleDbDataReader
        strSQL = "DELETE FROM ladies_skit.vw_fixtures_detail WHERE fixture_id = " & fixture_id
        myDataReader = objGlobals.SQLSelect(strSQL)

        strSQL = "INSERT INTO ladies_skit.fixtures_detail "
        ...
        strSQL = strSQL & " FROM  ladies_skit.fixtures_detail_temp WHERE fixture_id = " & fixture_id & " AND match <= 12 ORDER BY match"
        myDataReader = objGlobals.SQLSelect(strSQL)

        'update the fixture_calendar date FROM ladies_skit.vw_fixtures
        strSQL = "UPDATE ladies_skit.vw_fixtures_detail SET fixture_calendar = (SELECT fixture_calendar FROM ladies_skit.vw_fixtures WHERE fixture_id = " & fixture_id & ") WHERE fixture_id = " & fixture_id
        myDataReader = objGlobals.SQLSelect(strSQL)
        objGlobals.close_connection()

        'update the fixture_calendar short date FROM ladies_skit.vw_fixtures
        strSQL = "UPDATE ladies_skit.vw_fixtures_detail SET fixture_short_date = (SELECT fixture_short_date FROM ladies_skit.vw_fixtures WHERE fixture_id = " & fixture_id & ") WHERE fixture_id = " & fixture_id
        myDataReader = objGlobals.SQLSelect(strSQL)
        objGlobals.close_connection()
    End Sub
