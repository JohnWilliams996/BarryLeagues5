...
Partial Class Admin_Website_Activity
    ...
    Protected Sub btnAdd_Click(sender As Object, e As System.EventArgs) Handles btnAdd.Click
        ...
        strSQL = "SELECT * FROM  ladies_skit.my_ip_addresses WHERE ip_address = '" + txtIPAddress.Text + "'"
        ...
        strSQL = "INSERT INTO ladies_skit.my_ip_addresses VALUES ("
        strSQL = strSQL + "'" + txtIPAddress.Text + "',"
        strSQL = strSQL + "'" + txtLocation.Text + "')"
        myDataReader = objGlobals.SQLSelect(strSQL)

        Response.Redirect("~/Ladies_Skit/Admin/Website Activity.aspx")
    End Sub
