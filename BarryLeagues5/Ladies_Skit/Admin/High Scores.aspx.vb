...
Partial Class Admin_High_Scores
    ...
    Sub load_teams()
        ...
        Dim myDataReader As oledbdatareader
        ddTeam.Items.Clear()
        strSQL = "SELECT DISTINCT(long_name) FROM ladies_skit.vw_teams WHERE league = '" & ddLeague.Text & "' AND long_name <> 'BYE'"
    ...
    Sub load_players()
        ...
        strSQL = "SELECT player FROM ladies_skit.vw_players WHERE league = '" & ddLeague.Text & "' AND team = '" & ddTeam.Text & "'"
    ...
    Protected Sub btnAddHS_Click(sender As Object, e As System.EventArgs) Handles btnAddHS.Click
        ...
        Dim strSQL As String
        Dim myDataReader As oledbdatareader
        strSQL = "INSERT INTO ladies_skit.high_scores VALUES ("
        ...
        End If
        myDataReader = objGlobals.SQLSelect(strSQL)
        Response.Redirect("~/Ladies_Skit/Admin/High Scores.aspx")
    End Sub
