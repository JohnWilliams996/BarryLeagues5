...
Partial Class Ladies_Skit_Meeting_Minutes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            strSQL = "SELECT meeting_date FROM ladies_skit.league_meetings WHERE filename IS NOT NULL ORDER BY Date8 DESC"
    ...
    Protected Sub btnOpenWebsite_Click(sender As Object, e As System.EventArgs) Handles btnOpenWebsite.Click
        Dim strSQL As String
        Dim myDataReader As OleDbDataReader
        strSQL = "SELECT filename FROM ladies_skit.league_meetings WHERE meeting_date = '" & rbMeetings.SelectedValue & "'"
        myDataReader = objGlobals.SQLSelect(strSQL)
        While myDataReader.Read()
