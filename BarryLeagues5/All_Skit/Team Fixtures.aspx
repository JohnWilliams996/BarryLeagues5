<%@ Page Title="" Language="VB" Debug="true" MasterPageFile="~/All_Skit/MasterPage.master" AutoEventWireup="false" CodeFile="Team Fixtures.aspx.vb" Inherits="Team_Fixtures" %>
        ...
        <tr>
          <td>
            <asp:Label ID="Label4" Text="Click on a Team to view the Fixtures" 
                ...
                style="text-align:center"  Height="20px" Width="304px"
         ...
         <td>
              <asp:Label ID="lblTeam" runat="server" Font-Names="Arial" ForeColor="Yellow"  Text="TEAM"
                     Width="333px" Font-Size="18px" Height="22px" style="text-align:left" 
                  BackColor="#1B1B1B"></asp:Label>
            <br />
            <br />
          </td>
         ...
         <tr>
           ...
           <td colspan="2" valign = "top">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Away Team Name" HeaderText="Venue">
                    <HeaderStyle ForeColor="DarkKhaki" HorizontalAlign="cENTER" Wrap="False"/>
