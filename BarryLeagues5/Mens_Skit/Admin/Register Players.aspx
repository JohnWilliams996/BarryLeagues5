<%@ Page Title="" Language="VB" MasterPageFile="~/Mens_Skit/MasterPage.master" AutoEventWireup="false" CodeFile="Register Players.aspx.vb" Inherits="Register_Players" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <asp:SqlDataSource ID="SqlDataSourceDivision1" runat="server"         
        SelectCommand="SELECT * FROM mens_skit.vw_players WHERE league = 'DIVISION 1' ORDER BY league, team, player "
        DeleteCommand="DELETE FROM mens_skit.vw_players WHERE ID = @ID" 
        UpdateCommand="UPDATE mens_skit.vw_players SET League = @League, Team = @Team,  Player = @Player, Phone = @Phone, Contact = @Contact WHERE ID = @ID">
        <DeleteParameters>
   ...
   <asp:SqlDataSource ID="SqlDataSourceDivision2" runat="server"         
        SelectCommand="SELECT * FROM mens_skit.vw_players WHERE league = 'DIVISION 2' ORDER BY league, team, player"
        DeleteCommand="DELETE FROM mens_skit.vw_players WHERE ID = @ID" 
        UpdateCommand="UPDATE mens_skit.vw_players SET League = @League, Team = @Team,  Player = @Player, Phone = @Phone, Contact = @Contact WHERE ID = @ID">
        <DeleteParameters>
            <asp:Parameter Name="ID" />
   ...
   <asp:SqlDataSource ID="SqlDataSourceDivision3" runat="server"         
        SelectCommand="SELECT * FROM mens_skit.vw_players WHERE league = 'DIVISION 3' ORDER BY league, team, player"
        DeleteCommand="DELETE FROM  mens_skit.vw_players WHERE ID = @ID" 
        UpdateCommand="UPDATE mens_skit.vw_players SET League = @League, Team = @Team,  Player = @Player, Phone = @Phone, Contact = @Contact WHERE ID = @ID">
        <DeleteParameters>
            <asp:Parameter Name="ID" />
   ...
   <asp:SqlDataSource ID="SqlDataSourceDivision4" runat="server"         
        SelectCommand="SELECT * FROM mens_skit.vw_players WHERE league = 'DIVISION 4' ORDER BY league, team, player"
        DeleteCommand="DELETE FROM  mens_skit.vw_players WHERE ID = @ID" 
        UpdateCommand="UPDATE mens_skit.vw_players SET League = @League, Team = @Team,  Player = @Player, Phone = @Phone, Contact = @Contact WHERE ID = @ID">
        <DeleteParameters>
            <asp:Parameter Name="ID" />
