<%@ Page Title="" Language="VB" MasterPageFile="~/Mens_Skit/MasterPage.master" AutoEventWireup="false" CodeFile="Website Activity.aspx.vb" Inherits="Admin_Website_Activity" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <asp:SqlDataSource ID="SqlDataSource1" runat="server"
        SelectCommand="SELECT TOP 1000 a.id,a.web_page,a.ip_address,a.visit_date,a.is_me,a.admin_user,b.Location from mens_skit.page_visits a LEFT OUTER JOIN mens_skit.my_ip_addresses b ON b.ip_address = a.ip_address  WHERE a.web_page <> 'GoogleBot Crawler' ORDER BY a.id DESC" >
   </asp:SqlDataSource>
  ...
  <asp:Label ID="lblNoIP" runat="server" BackColor="#1B1B1B" Font-Names="Arial" ForeColor="#E4BB18" Text="No IP Address Entered"> </asp:Label>
   ...
   <asp:SqlDataSource ID="SqlDataSourcemy_ip_addresses" runat="server"         
        SelectCommand="SELECT id,ip_address,location FROM mens_skit.my_ip_addresses ORDER BY ip_address"
        DeleteCommand="DELETE FROM mens_skit.my_ip_addresses WHERE id = @ID" 
        UpdateCommand="UPDATE mens_skit.my_ip_addresses SET ip_address = @ip_address, location = @Location WHERE id = @ID">
        <DeleteParameters>
