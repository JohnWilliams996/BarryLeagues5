...
Partial Class Register_Players
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            Exit Sub
        End If
        SqlDataSourceDivision1.ConnectionString = objGlobals.getDataSourceConnectionString
        SqlDataSourceDivision2.ConnectionString = objGlobals.getDataSourceConnectionString
        SqlDataSourceDivision3.ConnectionString = objGlobals.getDataSourceConnectionString
        SqlDataSourceDivision4.ConnectionString = objGlobals.getDataSourceConnectionString
    ...
    Sub load_add_teams()
        ...
        strSQL = "SELECT DISTINCT(long_name) FROM mens_skit.vw_teams WHERE league = '" & ddAddLeague.Text & "' AND long_name <> 'BYE'"
    ...
    Sub load_change_teams()
        ...
        strSQL = "SELECT DISTINCT(long_name) FROM mens_skit.vw_teams WHERE league = '" & ddChangeLeague.Text & "' AND long_name <> 'BYE'"
        strSQL = strSQL + " ORDER BY long_name"
        myDataReader = objGlobals.SQLSelect(strSQL)
        While myDataReader.Read
    ...
    Sub load_change_players()
        ...
        strSQL = "SELECT player FROM mens_skit.vw_players WHERE league = '" & ddChangeLeague.Text & "' AND team = '" & ddChangeTeam.Text & "'"
    ...
    Protected Sub btnAddPlayer_Click(sender As Object, e As System.EventArgs) Handles btnAddPlayer.Click
        ...
        strSQL = "SELECT Phone FROM mens_skit.vw_players WHERE league = '" + ddAddLeague.Text + "'"
        ...
        strSQL = "INSERT INTO mens_skit.players VALUES ("
    ...
    Protected Sub btnChangePlayer_Click(sender As Object, e As System.EventArgs) Handles btnChangePlayer.Click
        ...
        strSQL = "EXEC mens_skit.sp_Change_Player_Name '" & objGlobals.current_season & "','" & ddChangeLeague.Text & "','" & ddChangeTeam.Text & "','" & ddChangePlayer.Text & "','" & txtChangeNewName.Text & "'"
        myDataReader = objGlobals.SQLSelect(strSQL)
