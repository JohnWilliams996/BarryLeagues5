<%@ Page Title="" Language="VB" MasterPageFile="~/Mens_Skit/MasterPage.master" AutoEventWireup="false" CodeFile="Stats.aspx.vb" Inherits="Stats" MaintainScrollPositionOnPostback="true"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <asp:Label ID="Label2" runat="server" Text="2. Select Team"  
             ...
             <asp:GridView ID="gridTeams" runat="server" CssClass="gv"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Team9" HeaderText="">
                        <ItemStyle ForeColor="Cyan" BackColor="#1B1B1B"  HorizontalAlign="left" Wrap="False"/>
                    </asp:BoundField>   
                </Columns>
                <FooterStyle BackColor="#990000" ForeColor="White" Font-Bold="True" />
    ...
    <tr>
        <td valign="top">
            ...
            <br />
            <asp:Label ID="lblPositionStats" Text="AVERAGE BY POSITION PLAYED" Height="33px"  
                    runat="server" ForeColor="#E4BB18" BackColor="#1B1B1B" BorderWidth="0px" 
                Font-Names="Arial" Font-Size="16px"
                Visible="False"></asp:Label>

                
            <asp:GridView ID="gridPositionStats" runat="server" CssClass="gv"
                style="margin-top: 0px" 
                AutoGenerateColumns="False"
                Font-Names="Arial" BackColor="#1B1B1B" cellspacing="2"
                CellPadding="2" ShowHeader="False" ForeColor="#333333" Font-Size="12px"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Played" HeaderText="">
                <ItemStyle BackColor="#1B1B1B" ForeColor="LightGreen" HorizontalAlign="Center"  Wrap="False" />
                </asp:BoundField>

                <asp:BoundField DataField="Average" HeaderText="">
                <ItemStyle BackColor="#1B1B1B" ForeColor="Cyan" HorizontalAlign="Center"  Wrap="False" />
                </asp:BoundField>
