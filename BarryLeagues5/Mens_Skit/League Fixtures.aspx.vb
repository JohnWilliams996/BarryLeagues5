...
Partial Class League_Fixtures
    ...
    Sub load_leagues()
        ...
        strSQL = "SELECT league FROM mens_skit.vw_leagues ORDER BY league"
    ...
    Sub load_fixtures()
        ...
        strSQL = "SELECT long_name,home_night,phone_number FROM mens_skit.vw_teams "
        ...
        dt.Columns.Add(New DataColumn("Wk42", GetType(System.String)))
        For Team = 1 To TeamCount
            ...
            strSQL = strSQL & " FROM mens_skit.vw_fixtures a "
            strSQL = strSQL & " LEFT OUTER JOIN mens_skit.vw_teams b ON a.away_team_name = b.long_name AND b.league = a.league"
            ...
            strSQL = strSQL & " FROM mens_skit.vw_fixtures a "
            strSQL = strSQL & " INNER JOIN mens_skit.vw_teams b ON a.home_team_name = b.long_name AND b.league = a.league"
    ...
    Private Sub gridLeagues_RowDataBound(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gridLeagues.RowDataBound
        If (e.Row.RowType = DataControlRowType.DataRow) Then
            ...
            hLink.NavigateUrl = "~/Mens_Skit/League Fixtures.aspx?League=" & dt.Rows(gRow)(0).ToString
