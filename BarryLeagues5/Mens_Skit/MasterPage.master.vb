...
Public Class MasterPage
    ...
    Sub load_teams()
        ...
        dt.Rows.Add("ASDAHOLICS", "BARRY PARK B", "")
        dt.Rows.Add("B.T.U.", "BILLY BLUEBIRDS", "")
        dt.Rows.Add("BILLY FLYERS", "BRITISH RAIL", "")
        dt.Rows.Add("BILLY WHIZZ", "CASTLE BOYS", "")
        dt.Rows.Add("BLUE MONKEY", "COLCOT BOYS", "")
        dt.Rows.Add("CANNON BALLS", "EX SERVICEMEN", "")
        dt.Rows.Add("CAVALIERS", "GARYS EXILES", "")
        dt.Rows.Add("GEEST", "LIBS LOBSTERS", "")
        dt.Rows.Add("HAIRY LEMONS", "PARK DRAGONS", "")
        dt.Rows.Add("MERRYMEN", "PARK LADS", "")
        dt.Rows.Add("MIGHTY DOCKERS", "POSTIES", "")
        dt.Rows.Add("ROYALISTS", "ROCK N BOWLERS", "")
        dt.Rows.Add("THE BILLY LADS", "TAKING LIBERTIES", "")
        dt.Rows.Add("WEST END RANGERS", "THE CELTS", "")
        dt.Rows.Add("WILLIE WOMBLES", "THE SLAMMERS", "")
        dt.Rows.Add("WITCHILL NOMADS", "WITCHILL POACHERS", "")
